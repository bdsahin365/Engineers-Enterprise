...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Engineers Enterprise'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    imoNumber: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    orderSteps: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatsappNumber: Schema.Attribute.String;
    whyChooseUs: Schema.Attribute.JSON;
  };
}
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderNo: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['DRAFT', 'CONFIRMED', 'DELIVERED']> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Construction material products';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    isPillar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    > &
      Schema.Attribute.Private;
    modelNo: Schema.Attribute.String;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pillarConfig: Schema.Attribute.JSON;
